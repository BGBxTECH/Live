...
document.addEventListener('DOMContentLoaded', function() {
    ...
    lockButton.style.top = '20px';
    lockButton.style.right = '20px';
    lockButton.style.zIndex = '1001';
    lockButton.style.backgroundColor = 'rgba(255, 255, 255, 0.7)';
    lockButton.style.border = 'none';
    lockButton.style.fontSize = '25px';
    ...
    const resetInactivityTimer = () => {
        ...
        inactivityTimer = setTimeout(() => {
            if (Date.now() - lastActivityTime >= 5000 && !isLocked) {
    ...
    const closeResolutionMenu = (resolutionMenu, resolutionButton, timeoutId) => {
...
//			manifestUri: 'https://cbsn-det.cbsnstream.cbsnews.com/out/v1/169f5c001bc74fa7a179b19c20fea069/master.m3u8',
    ...
    function createLoadingOverlay() {
        ...
        overlay.style.backgroundColor = 'rgba(43, 51, 63, 0.7)';
    ...
    function preloadAllStreams() {
        Object.values(streams).forEach(preloadStream);
    }
    ...
    resolutionButton.addEventListener('click', () => {
        if (resolutionMenu.style.display === 'none') {
            ...
            timeoutId = setTimeout(() => closeResolutionMenu(resolutionMenu, resolutionButton, timeoutId), 5000);
        } else {
            closeResolutionMenu(resolutionMenu, resolutionButton, timeoutId);
        }
    });
